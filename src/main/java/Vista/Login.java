...
public class Login extends javax.swing.JFrame {
    ...
    private void btnIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Optional<ClienteInfo> clienteInfoOpt =  clientesRespository.login(username, password);

        if (clienteInfoOpt.isEmpty()) {
            return;
        }

        try {
            VCliente vCliente = new VCliente(clienteInfoOpt.get());
    ...
    private void linkRecuperarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_linkRecuperarMouseClicked

    }//GEN-LAST:event_linkRecuperarMouseClicked
